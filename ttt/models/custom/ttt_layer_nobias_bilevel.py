...
class TTTBase(nn.Module):
    ...
    def setup(self):
        ...
        self.slow_update_freq = getattr(self.config, 'slow_update_freq', 10)
    ...
    def ttt(self, XQ, XK, XV, eta):
        ...
        def update_embed(XQ, XK, XV, eta, ttt_params=None, ttt_params_slow=None, counter=None):
        ...
        counter_cache = self.mini_batch_counter.value if hasattr(self, 'mini_batch_counter') else None
        
        outputs = update_embed(XQ, XK, XV, eta, ttt_params=ttt_params_cache, ttt_params_slow=ttt_params_slow_cache, counter=counter_cache)
