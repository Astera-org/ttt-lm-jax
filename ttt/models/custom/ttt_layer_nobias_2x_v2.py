...
class TTTLinearBase(TTTBase):
    def setup(self):
        ...
        # Add two parameter matrices for 2x parameters
        self.W1 = self.param(
            "ttt_dense_0",
    ...
    def process_mini_batch(
        ...
        X1 = XK_mini_batch
        # Apply both linear transformations in sequence
        Z1 = X1 @ W1_init
        Z2 = Z1 @ W2_init
        ...
        Z1_intermediate = X1_bar @ W1_init
        Attn2 = jnp.tril(Z1_bar @ Z1_intermediate.transpose(1, 0))
