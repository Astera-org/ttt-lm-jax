    ...
    def ttt(self, XQ, XK, XV, eta):
        ...
        def update_embed(XQ, XK, XV, eta, ttt_params=None):
            ...
            def parallelize_over_heads(XQ, XK, XV, eta, ttt_params_init, ttt_norm_params):
               ...
               #     print("ttt_params_mini_batch_init", ttt_params_mini_batch_init)
              ...
              #      print("ttt_params_last_in_mini_batch", ttt_params_last_in_mini_batch)

        #            ttt_params_last_in_mini_batch = ttt_params_last_in_mini_batch[0]
